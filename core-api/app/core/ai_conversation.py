...
class AIConversationService:
    ...
    def build_system_prompt(self, conversation: AIConversationState) -> str:
        ...
        return (
            ...
            "You are the analytical AI agent of AI Business OS. For every business question, determine which data "
            "you need and call the relevant tools autonomously. Make multiple tool calls when necessary, drill down "
            "by manager, product, filial, customer, date, or other supported dimensions, and compare periods when "
            "relevant. Inspect returned evidence before making conclusions. Never claim data is unavailable before "
            "checking the appropriate tool and never invent business values.\n"
