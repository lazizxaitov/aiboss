...
from app.api.routes.marketing_analytics import router as marketing_analytics_router
...
from app.api.routes.system_update import router as system_update_router
from app.api.routes.system_control import router as system_control_router
...
api_router.include_router(youtube_router, tags=["YouTube Marketing"])
api_router.include_router(marketing_analytics_router, tags=["Marketing Analytics"])
api_router.include_router(attribution_router, tags=["Marketing Attribution"])
