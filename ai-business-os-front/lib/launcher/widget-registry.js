...
export const FAMILY_CONTRACTS = {
  kpi: {
    // KPI tiles stay compact by design, but give them a two-step range
    // (small -> medium) instead of a single locked size.
    allowedSizes: ["3x2", "4x2"],
    defaultSize: "3x2",
    minSize: "3x2",
    maxSize: "4x2",
  ...
  chart: {
    ...
    previewContentLimit: 0,
    contentVariants: ["regular", "expanded", "xl"],
  },
  table: {
    allowedSizes: ["6x3", "12x4", "12x5"],
    defaultSize: "12x4",
    minSize: "6x3",
    maxSize: "12x5",
  ...
  summary: {
    allowedSizes: ["3x2", "6x3", "8x4"],
    defaultSize: "6x3",
    minSize: "3x2",
    maxSize: "8x4",
    overflowStrategy: "summary-preview",
    previewContentLimit: 3,
    contentVariants: ["compact", "regular", "expanded"],
  },
  alert: {
    allowedSizes: ["4x3", "6x3", "8x4"],
    defaultSize: "6x3",
    minSize: "4x3",
    maxSize: "8x4",
    overflowStrategy: "list-scroll",
